...
import { IchimokuCloudData, IchimokuCloudSeriesOptions } from "./series";
import { calculatePoints } from "./calculate-points";

import { Points } from "./point";

export class IchimokuCloudSeriesRenderer<TData extends IchimokuCloudData>
  implements ICustomSeriesPaneRenderer
{
  ...
  update(
    ...
    options: IchimokuCloudSeriesOptions,
  ) {
    this._data = data;
