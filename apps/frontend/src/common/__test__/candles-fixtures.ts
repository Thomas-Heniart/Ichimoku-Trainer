...
import { AllIndicators, Indicators } from '../../features/training/hexagon/models/indicators.model.ts'
...
export const neutralIndicatorsFinishingADay = (lastTimestamp = new UTCDate('2024-01-01')): AllIndicators => ({
...
export const neutralMarketCandles = (lastCandleTimestamp: UTCDate, intervalInMs: number): Indicators => {
